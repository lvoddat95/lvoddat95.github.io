...
var Dashboard = function () {
            ...
            var tooltip = d3.tip()
                ...
                .html(function (d) {
                    return '<ul class="list-unstyled mb-1">' +
                        ...
                        '<li>' + 'Đã bán: &nbsp;' + '<span class="font-weight-semibold float-right">' + d.alpha + '</span>' + '</li>' +
                        '<li>' + 'Doanh số: &nbsp; ' + '<span class="font-weight-semibold float-right">' + (d.alpha * 25).toFixed(2)  +'₫'+ '</span>' + '</li>' + 
                    '</ul>';
                });
    ...
    var _BarChart = function(element, barQty, height, animate, easing, duration, delay, color, tooltip) {
        ...
        if($(element).length > 0) {
            ...
            var bardata = 
            [
                {'name':"Trụ Sở Chính",'value': 70},
                {'name':"VNI Hải Phòng",'value': 190 },
                {'name':"VNI Đã Nẵng",'value': 120},
                {'name':"VNI HCM",'value': 140},
                {'name':"VNI Nghệ An", 'value': 230},
                {'name':"VNI Hà Nội",'value': 80},
                {'name':"VNI Thăng Long",'value': 110},
                {'name':"VNI Nam Hồng Hà",'value': 22},
                {'name':"VNI Hải Dương",'value': 34},
                {'name':"VNI Tây Nguyên",'value': 29},
                {'name':"Sở Giao Dịch",'value': 40},
                {'name':"VNI Quảng Ninh",'value': 120},
                {'name':"VNI Đông Đô",'value': 80},
                {'name':"VNI Thanh Hóa",'value': 66},
                {'name':"VNI Vĩnh Phúc",'value': 90},
                {'name':"VNI Bắc Giang",'value': 128},
                {'name':"VNI Đông Nam Bộ",'value': 221},
                {'name':"VNI Quảng Bình",'value': 175},
                {'name':"VNI Bình Định",'value': 152},
                {'name':"VNI Sài Gòn",'value': 40},
                {'name':"VNI Khánh Hòa",'value': 82},
                {'name':"VNI Nam Tây Nguyên",'value': 21},
                {'name':"VNI Quảng Ngãi",'value': 70},
                {'name':"VNI Thủ Đô",'value': 149},
                {'name':"VNI Tây Nam Bộ",'value': 190},
                {'name':"VNI Tân Sơn Nhất",'value': 290},
                {'name':"VNI Thành Đô",'value': 29},
                {'name':"VNI Bến Thành",'value': 40},
                {'name':"VNI Long An",'value': 123},
                // {'name':"VNI Tây Bắc",'value': 231},
                // {'name':"VNI Sông Hồng",'value': 30},
                // {'name':"VNI Tràng An",'value': 50},
                // {'name':"VNI Vũng Tàu",'value': 129},
                // {'name':"VNI Hà Thành",'value': 180},
                // {'name':"VNI Sở Giao Dịch 2",'value': 162},
                // {'name':"VNI Duyên Hải",'value': 149},
                // {'name':"VNI Huế",'value': 110},
                // {'name':"VNI Âu Lạc",'value': 80},
                // {'name':"VNI Bình Dương",'value': 99},
                // {'name':"VNI Vạn Xuân",'value': 20},
                // {'name':"VNI Kinh Đô",'value': 10},
                // {'name':"VNI Hà Tuyên",'value': 15},
                // {'name':"VNI Vĩnh Phúc",'value': 14},
            ];
          ...
          var bars = svg.selectAll('rect')
            ...
            if(tooltip == 'members') {
                tip.html(function (d, i) {
                    return '<div class="text-center">' +
                            '<h6 class="m-0">' + d.name + '</h6>' +
                            // '<span class="font-size-sm">members</span>' +
                            '<div class="font-size-sm">' + d.value + ' Tỷ</div>' +
                        '</div>'
                });
            }
